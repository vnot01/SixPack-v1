...
var routes = [
    ...
    {
        path: 'termsguest',
        loadChildren: function () { return Promise.all(/*! import() | pages-termsguest-termsguest-module */[__webpack_require__.e("default~pages-about-about-module~pages-aboutus-aboutus-module~pages-bmiinfo-bmiinfo-module~pages-bod~9dbe5797"), __webpack_require__.e("default~pages-signup-signup-module~pages-start-start-module~pages-termsguest-termsguest-module")]).then(__webpack_require__.bind(null, /*! ./pages/termsguest/termsguest.module */ "./src/app/pages/termsguest/termsguest.module.ts")).then(function (m) { return m.TermsguestPageModule; }); }
    },
    {
        path: 'forgotpass',
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, navCtrl, splashScreen, statusBar, router, afAuth, authService) {
...
var AdmobService = /** @class */ (function () {
    ...
    AdmobService.prototype.InterstitialAd = function () {
        var _this = this;
        this.admobFree.interstitial.isReady().then(function () {
            _this.admobFree.interstitial.show();
        });
    };
    AdmobService.prototype.BannerAd = function () {
        var bannerConfig = {
            isTesting: true,
            autoShow: true,
    ...
    AdmobService.prototype.HideBannerAd = function () {
        this.admobFree.banner.hide();
    };
    AdmobService.ctorParameters = function () { return [
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.doRestPass = function (value) {
        return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().sendPasswordResetEmail(value.email)
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    AuthService.prototype.restartApp = function () {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.platform.is('cordova')) {
                ...
                _this.fb.login(['public_profile'])
                    ...
                    var facebookCredential = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].FacebookAuthProvider.credential(response.authResponse.accessToken);
...
var FirebaseService = /** @class */ (function () {
    ...
    FirebaseService.prototype.getDisplayName = function () {
        var user = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
        if (user != null) {
            return user.displayName;
        }
    };
    FirebaseService.prototype.getCreationTime = function () {
        var user = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
        if (user != null) {
