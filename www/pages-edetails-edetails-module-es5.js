...
var EdetailsPage = /** @class */ (function () {
    ...
    EdetailsPage.prototype.play = function () {
        ...
        var videoUrl = this.exercise.exercise_video;
        var options = {
            successCallback: function () { console.info('Video played'); },
            errorCallback: function (e) { console.info('Error streaming'); },
    ...
    EdetailsPage.prototype.getCurrentPosition = function () {
    };
    ...
    EdetailsPage.prototype.setLandscape = function () {
        // set to portrait
        this.screenOrientation.lock(this.screenOrientation.ORIENTATIONS.LANDSCAPE);
    };
    EdetailsPage.prototype.getCurrentScreenOrientation = function () {
        // get current
        console.info(this.screenOrientation.type); // logs the current orientation, example: 'landscape'  
    };
    EdetailsPage.prototype.unlockScreenOrientation = function () {
        // allow user rotate
        this.screenOrientation.unlock();
    };
    EdetailsPage.prototype.lockScreenOrientation = function () {
        try {
            this.screenOrientation.lock(this.screenOrientation.ORIENTATIONS.PORTRAIT);
        }
        catch (error) {
    ...
    EdetailsPage.prototype.observeScreenOrientation = function () {
